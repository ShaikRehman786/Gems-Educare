...
const Home = () => {
  return (
    <>
      ...
      {/* SECTION 1 — HERO */}
      <section className="relative min-h-[85vh] flex items-center bg-white overflow-hidden py-20 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          <FadeInUp>
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-[4.5rem] font-bold text-primary leading-[1.1]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  ...
                  className="bg-primary text-white rounded-xl px-8 py-4 rounded text-sm font-bold uppercase tracking-wide flex items-center justify-center gap-2 hover:bg-navy transition-all transition-colors"
                >
                  Get Free Counselling <ArrowRight size={16} />
                </a>
                <Link
                  to="/fees"
                  className="border border-border text-text-primary px-8 py-4 rounded text-sm font-bold uppercase tracking-wide flex items-center justify-center hover:border-gray-900 hover:text-text-primary transition-colors"
                >
                  View Fee Structure
                </Link>
              </div>
              ...
              <div className="flex items-center gap-6 pt-8 border-t border-border">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-xs font-semibold text-text-secondary">
                    <span className="text-text-primary font-bold block text-sm">5000+</span> Students Enrolled
                  </div>
                </div>
                <div className="h-10 w-px bg-gray-200"></div>
                <div className="text-xs font-semibold text-text-secondary">
                  <span className="text-text-primary font-bold block text-sm">4.9/5</span> Google Rating
                </div>
              </div>
            </div>
          </FadeInUp>
          <div className="relative hidden lg:block">
            <FadeInUp delay={0.2}>
              <div className="aspect-[4/5] bg-section rounded-2xl overflow-hidden relative">
                {/* Placeholder for Hero Image */}
                <img src={heroDoctor} alt="Medical Professional" className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-700" /><div className="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent"></div>
              </div>
            </FadeInUp>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center divide-x divide-gray-200">
            {[
              ...
              <div key={idx} className="space-y-2">
                ...
                <div className="text-[10px] md:text-xs font-bold text-text-secondary tracking-[0.15em] uppercase">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="aspect-square bg-section rounded-2xl relative overflow-hidden flex items-center justify-center">
             <img src={adamBuilding} alt="Adam University Building" className="w-full h-full object-cover" />
          </div>
          <div>
            ...
            <p className="text-lg text-text-secondary mb-6 leading-relaxed">
              Adam University occupies a leading position in national university rankings and is represented by students from more than <strong className="text-text-primary font-semibold">25 different countries</strong>. Ranked among the Top Medical Colleges in Kyrgyzstan.
            </p>
            ...
            <table className="w-full text-left border-collapse">
              <thead className="bg-primary text-white">
                <tr className="border-b border-border">
                  <th className="p-6 text-xs font-bold uppercase tracking-wider">Parameters</th>
                  <th className="p-6 text-xs font-bold uppercase tracking-wider">India (Private)</th>
                  <th className="p-6 text-xs font-bold uppercase tracking-wider">Kyrgyzstan (Adam)</th>
                </tr>
              </thead>
              <tbody className="text-text-primary">
                {[
                  ...
                  <tr key={idx} className="border-b border-gray-50 last:border-0 hover:bg-section/50 transition-colors">
                    ...
                    <td className="p-6 text-sm text-text-secondary">{row.india}</td>
      ...
      <section className="bg-white py-24 px-4 border-b border-border">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left border-t border-border pt-12">
            <div>
              <p className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2">1st Year Tuition</p>
              <p className="text-xl font-bold text-text-primary">$5,600 <span className="text-sm font-normal text-text-secondary">(~₹5.3L)</span></p>
            </div>
            <div>
              <p className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2">Per Semester (Yr 2-5)</p>
              <p className="text-xl font-bold text-text-primary">$1,800 <span className="text-sm font-normal text-text-secondary">(~₹1.7L)</span></p>
            </div>
            <div>
              <p className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2">Hostel (1st Year)</p>
              <p className="text-xl font-bold text-text-primary">$1,150 <span className="text-sm font-normal text-text-secondary">(~₹1L)</span></p>
            </div>
          </div>
      ...
      <section className="bg-section py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-primary">Medical Facilities</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-xl border border-border flex flex-col items-center text-center gap-4 hover:border-primary transition-colors">
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-primary">What Our Students Say</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-8 rounded-xl border border-border bg-section/50 relative">
                <Quote className="text-primary/20 absolute top-6 right-6" size={40} />
                <div className="flex text-primary mb-6">
                  {[1,2,3,4,5].map(s => <Star key={s} size={14} fill="currentColor" />)}
                </div>
                <p className="text-text-secondary italic mb-8 text-sm leading-relaxed">"{t.text}"</p>
      ...
      <section className="bg-navy py-24 px-4 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-text-secondary text-sm md:text-base pb-8">
            Join over 5000+ Indian students who have trusted Gems Educare to guide them to Adam University.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="https://wa.me/919160404666"
              className="bg-primary text-white rounded-xl px-8 py-4 rounded text-sm font-bold uppercase tracking-wide hover:bg-navy transition-all transition-colors"
            >
              Get Free Counselling
            </a>
            <Link
              to="/contact"
              className="bg-primary text-white px-8 py-4 rounded text-sm font-bold uppercase tracking-wide hover:bg-navy transition-colors"
            >
              Apply Now
            </Link>
          </div>
