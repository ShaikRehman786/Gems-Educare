...
const WelcomeModal = () => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-border w-full max-w-2xl overflow-hidden animate-modal-in"
      ...
      >
        ...
        <div className="px-8 pt-8 pb-4 text-center relative border-b border-gray-50">
          <button
            ...
            className="absolute top-6 right-6 w-8 h-8 rounded-full bg-section hover:bg-section flex items-center justify-center transition-colors text-text-secondary hover:text-text-primary"
            aria-label="Close"
          >
            <X size={18} />
          </button>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-2 font-playfair">
        ...
        <div className="px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 border border-primary text-primary px-6 py-4 rounded text-sm font-bold tracking-wide uppercase hover:bg-secondary/5 transition-colors"
            >
